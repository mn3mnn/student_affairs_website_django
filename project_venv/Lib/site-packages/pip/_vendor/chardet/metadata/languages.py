...
class Language(object):
    ...
    :type alphabet: str
    :ivar wiki_start_pages: The Wikipedia students to start from if we're crawling
...
LANGUAGES = {'Arabic': Language(name='Arabic',
             ...
             # simple way to get the Latin alphabet students from Wikipedia through
             ...
             'Vietnamese': Language(name='Vietnamese',
                                    ...
                                    # dozens of 8-bit Vietnamese code students are
